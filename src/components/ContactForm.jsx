...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="relative py-20 sm:py-24 bg-gradient-to-b from-indigo-50/40 to-pink-50/60">
      <div className="mx-auto max-w-3xl px-6">
        <div className="mx-auto max-w-xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-pink-50 px-3 py-1 text-xs text-pink-600 ring-1 ring-pink-200">
          ...
          <p className="mt-3 text-slate-600">Have questions about pricing, features, or enterprise? Drop us a note.</p>
        </div>

        <form onSubmit={onSubmit} className="mt-10 space-y-4 rounded-2xl bg-white/80 p-6 shadow-sm ring-1 ring-slate-200 backdrop-blur-sm">
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="flex items-center gap-2 rounded-xl bg-white px-3 ring-1 ring-slate-200 focus-within:ring-indigo-300">
          ...
          <label className="flex items-start gap-2 rounded-xl bg-white px-3 ring-1 ring-slate-200 focus-within:ring-indigo-300">
          ...
          <div className="flex items-center justify-between gap-3">
            <p className="text-sm text-slate-600">We typically respond within 1–2 business days.</p>
            <button
              type="submit"
