...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[70vh] overflow-hidden bg-gradient-to-b from-pink-50 via-indigo-50 to-white">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 pt-20 pb-16 sm:pt-28">
        <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white/70 px-3 py-1 text-xs text-indigo-700 backdrop-blur-sm shadow-sm">
          <Shield className="h-3.5 w-3.5" />
          Bank‑grade security for modern commerce
        </div>

        <h1 className="mt-6 text-center font-semibold tracking-tight text-slate-900" style={{ fontFamily: 'Manrope, Inter, system-ui' }}>
        ...
        <p className="mt-5 max-w-2xl text-center text-slate-600 sm:text-lg">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            href="#auth"
            className="inline-flex items-center gap-2 rounded-xl bg-white/80 px-5 py-3 text-indigo-700 ring-1 ring-indigo-200 backdrop-blur-sm transition hover:bg-white"
          >
